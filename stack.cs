...
namespace stack_int
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(MyStack.Contains(18));//contains
            Console.WriteLine(MyStack.Contains(16));
            Console.WriteLine(MyStack.Contains(2));//contains
            Console.WriteLine(MyStack.Contains(14));
            Console.WriteLine(MyStack.Contains(10));//contains
            Console.WriteLine(MyStack.Contains(4));

            Console.WriteLine("The current elements prsesnt in the queue" + MyStack.Count());//count
