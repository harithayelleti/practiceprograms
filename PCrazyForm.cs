...
namespace WindowsFormsPrintingcrazy
{
    public partial class PCrazyForm : Form
    {
        public PCrazyForm()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //this.button1.Click += new System.EventHandler(this.button1_click);//Delegate been ccreatedd
        }
        /*//Method creation
